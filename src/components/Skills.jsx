...
function Skills() {
  return (
    <div id='skills' className='pt-16 lg:pt-24'>
      <div className='max-w-main  mx-4  sm:mx-11  lg:mx-24 2xl:mx-auto relative mb-20 sm:mb-44 xl:my-44 xl:flex' >
        <div className='xl:w-1/2 text-xl sm:text-2xl 2xl:text-3xl min-[2500px]:text-4xl xl:mr-16 text-[#666] sm:mb-40'>
          <h2 className='text-3xl sm:text-4xl 2xl:text-5xl  font-bold text-[#333] text-center'>Check out my Skills!</h2>
          <div className='h-3 w-16 bg-[#7843e9] rounded-full mx-auto mt-4 mb-10 '></div>
          ...
          <Link className='text-blue-700 my-3 block cursor-pointer' to="projects"  smooth={true}  duration={800}>🚀 Try It Out! 🚀</Link>
