...
import './styles/MySparkleButton.css'

const MySparkleButton = () => {
  ...
  return (
    <div className="sparkle-button z-30 w-full h-4">
      <Link to="projects"  smooth={true}  duration={800}><button>
...
export default MySparkleButton;
